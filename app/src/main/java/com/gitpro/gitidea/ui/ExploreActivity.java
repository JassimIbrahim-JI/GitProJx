...
import com.gitpro.gitidea.fragments.NotificationFragment;
import com.gitpro.gitidea.fragments.ProfileFragment;
import com.gitpro.gitidea.fragments.SearchFragment;
    ...
    private void initViews(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if (intent != null) {
                ...
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new ProfileFragment()).commitNow();
            } else {
