...
public class TopicViewPager extends FragmentStateAdapter {

    Context context;
    ArrayList<Fragment> fragmentList=new ArrayList<>();

    public TopicViewPager(@NonNull Context context, @NonNull FragmentManager fragmentManager, @NonNull Lifecycle lifecycle) {
